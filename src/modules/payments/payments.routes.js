...
paymentsRouter.post('/:orderId/mark-cod', authenticate, authorize('user', 'admin'), asyncHandler(controller.markCod))
paymentsRouter.post('/:orderId/refund', authenticate, authorize('user', 'admin'), validate(refundSchema), asyncHandler(controller.refund))
